// SPIGlobalHookEx.cpp : Defines the entry point for the DLL application.
//
...
LRESULT CALLBACK WINAPI CBTProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  ...
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,CBT_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI DebugProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,DEBUG_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI ForegroundIdleProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  ...
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,FOREGROUNDIDLE_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI GetMsgProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,GETMESSAGE_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI KeyboardProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,KEYBOARD_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI KeyboardLLProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  ...
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,KEYBOARDLL_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI MouseProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,MOUSE_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI MouseLLProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,MOUSELL_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI MessageProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,MSGFILTER_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
...
LRESULT CALLBACK WINAPI ShellProc(int nCode,WPARAM wParam,LPARAM lParam)
{
  INT RT; 
	...
	RT = SendMessage(ExeHwnd,SHELL_MSG,4,lParam);
	if (RT)
	{
		return RT;
	} else {
